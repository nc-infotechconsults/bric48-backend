...
public abstract class BaseService<R, RS, E, ID> {
    ...
    protected E afterSave(E entity){return entity;}
    protected E beforeUpdate(E entity){return entity;}
    protected E afterUpdate(E entity){return entity;}
    protected E beforeDelete(E entity){return entity;}
    protected void afterDelete(E entity){}

    // method called for intermediate business logic
    protected E beforeSaveIntraservice(E entity){return entity;}
    protected E afterSaveIntraservice(E entity){return entity;}
    protected E beforeUpdateIntraservice(E entity){return entity;}
    protected E afterUpdateIntraservice(E entity){return entity;}
    protected E beforeDeleteIntraservice(E entity){return entity;};
    protected E afterDeleteIntraservice(E entity){return entity;};
